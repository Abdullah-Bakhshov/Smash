...
class PermissionManager {
    ...
    // Async task, in swift the async variables or tasks will be put into a thread pool which then allows for swift to handle the tasks without actually context switching reducing the overhad making you carry out the task faster.
